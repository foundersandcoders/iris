---
name: "Iris: Create Status Report"
description: "Create a status report that knows what you've done since the last one"
model: haiku
...
<output-format template-path="~/.claude/templates/status-report.md">
